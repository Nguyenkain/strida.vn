...
function WordPress_MagicZoom_send_stat($action = '') {
    ...
    if('working' == 'v5.12.31' || 'working' == 'v4.5.30') {
        return;
    }
    ...
    $path = "api/stat/?action={$action}&tool_name=magiczoom&license=trial&tool_version=v4.5.30&module_version=v5.12.31&platform_name=wordpress&platform_version={$platformVersion}&url={$url}";
...
function  magictoolbox_WordPress_MagicZoom_init() {
    ...
    add_action("wp_head", "magictoolbox_WordPress_MagicZoom_styles",$priority); //load scripts and styles
...
function  magictoolbox_WordPress_MagicZoom_config_page($id) {
    ...
    <p style="font-size:15px;">Learn about all the <a href="http://www.magictoolbox.com/magiczoom/integration/" target="_blank">Magic Zoom&trade; settings and examples too!</a>&nbsp;|&nbsp;<a href="http://www.magictoolbox.com/contact/">Get support</a></p>
