...
function fnPropertyChanged() {
    if (window.event.propertyName == "src") {
        ...
        if (!el.src.match(/x\.gif$/i)) {
            ...
            el.src = "x.gif"/*tpa=http://strida.vn/components/com_virtuemart/x.gif*/;
        }
    }
}
