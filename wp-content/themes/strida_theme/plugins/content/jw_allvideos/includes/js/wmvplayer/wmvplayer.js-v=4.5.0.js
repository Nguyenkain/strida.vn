...
jeroenwijering.View.prototype = {
	...
	onTime: function(elp,dur) {
		...
		if(dur > 0) {
			...
			snd.findName("TimeSymbol")['http://strida.vn/plugins/content/jw_allvideos/includes/js/wmvplayer/Canvas.Left'] = pos+4;
	...
	resizePlayer: function() {
		...
		if(this.configuration['shownavigation'] == 'true') {
			if(fss == true) {
				...
				this.controlbar['http://strida.vn/plugins/content/jw_allvideos/includes/js/wmvplayer/Canvas.Left'] = Math.round(wid/2-250);
				...
				this.controlbar['http://strida.vn/plugins/content/jw_allvideos/includes/js/wmvplayer/Canvas.Left'] = 0;
	...
	resizeDisplay: function(wid,hei) {
		...
		this.display.findName('OverlayCanvas')['http://strida.vn/plugins/content/jw_allvideos/includes/js/wmvplayer/Canvas.Left'] = wid -
			this.display.findName('OverlayCanvas').Width - 10;
		this.display.Visibility = "Visible";
	},

	resizeControlbar: function(wid,yps,alp) {
		this.controlbar['http://strida.vn/plugins/content/jw_allvideos/includes/js/wmvplayer/Canvas.Top'] = yps;
		...
		this.stretchElement('TimeHighlight',tsb['http://strida.vn/plugins/content/jw_allvideos/includes/js/wmvplayer/Canvas.Left']-5);
		this.controlbar.Visibility = "Visible";
	},

	centerElement: function(nam,wid,hei) {
		var elm = this.configuration['sender'].findName(nam);
		elm['http://strida.vn/plugins/content/jw_allvideos/includes/js/wmvplayer/Canvas.Left'] = Math.round(wid/2 - elm.Width/2);
		elm['http://strida.vn/plugins/content/jw_allvideos/includes/js/wmvplayer/Canvas.Top'] = Math.round(hei/2 - elm.Height/2);
	},
	...
	placeElement: function(nam,xps,yps) {
		var elm = this.configuration['sender'].findName(nam);
		elm['http://strida.vn/plugins/content/jw_allvideos/includes/js/wmvplayer/Canvas.Left'] = xps;
		if(yps) { elm['http://strida.vn/plugins/content/jw_allvideos/includes/js/wmvplayer/Canvas.Top'] = yps; }
	}
}
